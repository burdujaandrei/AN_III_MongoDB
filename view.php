  ...
  <!-- 
	...
	<body>
        ...
        <?php
            ...
            $_SESSION['title'] = "SESSION ". $doc->title;
        ?>
				...
				<div class="fh5co-text">
					<div class="container">
						<div class="row text-center">
							<h1 class="animate-box"><?php echo $_SESSION['title'];?></h1>
			...
			<div class="container">
				<div class="row r-pb">
					<div class="col-md-8 col-md-offset-2 text-center section-heading">
						...
						<p class="fh5co-lead animate-box"><?php echo $doc->content;?></p>
					</div>
				</div>

				<div class="row">
					<figure class="animate-box">
						<img src="<?php echo $doc->image;?>" alt="Free HTML5 template by FREEHTML5.co" class="img-responsive">
					</figure>
				</div>
                         
                            
                          <a href="edit.php?id=<?php echo $doc->_id;?>"> Edit</a>
